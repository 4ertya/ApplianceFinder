...
public final class SearchCriteria {
    ...
    public static Set<String> StringParams = new HashSet<>() {
        {
            add("FILTER_TYPE");
            add("BAG_TYPE");
            add("WAND_TYPE");
    ...
    public static Set<String> NumberParams = new HashSet<>() {
        {
            ...
            add("SYSTEM_MEMORY");
            add("DISPLAY_INCHES");
            add("FREEZER_CAPACITY");
            add("CPU");
            add("BATTERY_CAPACITY");
            add("HEIGHT");
            add("WIDTH");
            add("OVERALL_CAPACITY");
            add("MOTOR_SPEED_REGULATION");
            add("CLEANING_WIDTH");
            add("FLASH_MEMORY_CAPACITY");
           add("NUMBER_OF_SPEAKERS");
           add("CORD_LENGTH");
        }
    };
